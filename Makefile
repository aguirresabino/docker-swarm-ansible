...
test: ## Run complete test suite
	...
	@$(DOCKER_COMPOSE) exec $(ANSIBLE_CONTAINER) bash -c "cd roles/docker_manager && molecule test"
	@$(DOCKER_COMPOSE) exec $(ANSIBLE_CONTAINER) bash -c "cd roles/docker_worker && molecule test"
